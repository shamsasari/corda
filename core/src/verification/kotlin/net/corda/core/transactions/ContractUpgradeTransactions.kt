...
private constructor(
    ...
    companion object {
        ...
        internal fun resolve(verificationSupport: VerificationSupport,
                             wireTx: ContractUpgradeWireTransaction,
            ...
            val legacyContractAttachment = verificationSupport.getAttachment(wireTx.legacyContractAttachmentId)
                    ?: throw AttachmentResolutionException(wireTx.legacyContractAttachmentId)
            val upgradedContractAttachment = verificationSupport.getAttachment(wireTx.upgradedContractAttachmentId)
            ...
            val upgradedContract = loadUpgradedContract(wireTx.upgradedContractClassName, wireTx.id, verificationSupport.appClassLoader)
