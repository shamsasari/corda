...
interface VerifyingServiceHub : ServiceHub, VerificationSupport {
    ...
    private fun getContractUpdateOutput(wtx: ContractUpgradeWireTransaction, outputIndex: Int): SerializedTransactionState {
        ...
        val legacyAttachment = getAttachment(wtx.legacyContractAttachmentId) ?: throw MissingContractAttachments(emptyList())
        val upgradedAttachment = getAttachment(wtx.upgradedContractAttachmentId) ?: throw MissingContractAttachments(emptyList())
        ...
        return AttachmentsClassLoaderBuilder.withAttachmentsClassloaderContext(
            ...
            val outputState = calculateUpgradedState(binaryInput.deserialize(), upgradedContract, upgradedAttachment)
